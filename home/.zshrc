...
export PATH=/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/X11/bin:/usr/local/git/bin:$HOME/.bin:$PATH
...
function getIP () {
  ssh will@omepf cat /var/www/html/strippedCSV | grep ${1} | awk -F “,” ‘{print $3}’
}
